...
export default function ChatWorkspace({
    ...
    return (
        <main className="relative flex min-w-0 flex-1 flex-col bg-[#0d0d11]">
                ...
                <div className="mx-auto flex min-h-full w-full max-w-4xl flex-col px-4 py-7 sm:px-7 sm:py-10 lg:px-10">
                    {loadingSession ? (
                        <div
                            ...
                            role="status"
                        >
                            <span className="h-7 w-7 animate-spin rounded-full border-2 border-neutral-800 border-t-blue-500" />
                        ...
                        <div className="m-auto w-full max-w-2xl py-10 text-center">
                            ...
                            <div className="mt-7 flex flex-wrap justify-center gap-2">
                                {suggestions.map((suggestion) => (
                                    <button
                                        ...
                                        className="rounded-full border border-neutral-800 bg-neutral-900/60 px-3.5 py-2 text-xs text-neutral-400 transition-colors hover:border-blue-500/30 hover:bg-blue-500/5 hover:text-blue-300"
                                    >
                                        {suggestion}
                                    </button>
                                ))}
                            ...
                            <p className="mt-6 inline-flex items-center gap-2 rounded-full border border-neutral-800 px-3 py-1.5 text-xs text-neutral-500">
                                {hasSelection ? (
            ...
            <div className="relative shrink-0 border-t border-white/[0.04] bg-[#0d0d11]/95 px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-xl sm:px-6 sm:pb-5 sm:pt-4">
                <div className="mx-auto w-full max-w-3xl">
                    ...
                    />
                    <p className="mt-2 hidden text-center text-[11px] text-neutral-700 sm:block">
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <div className="flex items-center gap-1.5 rounded-2xl rounded-tl-md border border-white/[0.06] bg-[#1b1b20] px-5 py-4">
                    {[0, 1, 2].map((index) => (
                        <span
                            key={index}
