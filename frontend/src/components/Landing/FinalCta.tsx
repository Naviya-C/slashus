...
export default function FinalCta() {
    ...
    return (
        <section className="bg-white px-5 pb-24 sm:px-6 lg:pb-32">
            <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] bg-neutral-950 px-7 py-16 text-center text-white sm:px-12 sm:py-20">
